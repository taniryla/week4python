...
class LinkedList:
    ...
    def prepend(self, value):
        ...
        if self.head is None:  # if there is None value attached to the head
            self.head = new  # now we are creating a head since we now have 2 nodes
            print("Head Node created:", self.head.value)
            return
        ...
        print("Prepend new Head Node with value", new.value)
        print("Node following Head is:", old.value)
